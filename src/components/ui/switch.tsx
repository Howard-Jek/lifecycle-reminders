...
/**
 * The one control that is NOT the action colour.
 *
 * A switch does not perform an action, it reports a state — and a black "on"
 * reads as dead rather than enabled, because black is also roughly what
 * disabled and inert things look like. Orange says on and cannot be misread.
 */
